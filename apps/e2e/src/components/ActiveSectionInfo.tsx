...
export const ActiveSectionInfo = ({
  hideTestIds,
}: ActiveSectionInfoProps = {}) => {
  const { trackingId, scrolledRatioMotionValue } =
    useActiveSectionMotionValue();
    ...
    <div className="active-info">
      ...
      >
        <div style={{ marginBottom: "1rem" }}>
          <small>
            Active Section ={" "}
            <b data-testid={hideTestIds ? undefined : "active-section-id"}>
              {trackingId}
            </b>
            :
          </small>
        ...
        <div>
          ...
          >
            <b
              className={trackingId ? TEXT_COLOR[trackingId] : ""}
              data-testid={hideTestIds ? undefined : "active-section-label"}
            >
              {trackingId}
            </b>
          </span>{" "}
        ...
        <div style={{ marginTop: "1rem" }}>
          ...
          >
            ...
            >
              <motion.b
                data-testid={hideTestIds ? undefined : "active-section-ratio"}
              >
                {displayValue}
              </motion.b>
            </motion.div>
