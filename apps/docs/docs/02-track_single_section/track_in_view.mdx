...
import { IntersectionSection } from '../../src/components/single/IntersectionSection';

Detect whether an element is in view with the Intersection Observer API.

<IntersectionSection className="border-green-400 dark:border-green-700 bg-green-200/20 dark:bg-green-800/20" />
