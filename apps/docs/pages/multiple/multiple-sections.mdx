...
<StickyContainer
  overlay={
    <>
      <TrackedSection className="border-rose-400 dark:border-rose-700" />
      <TrackedSection className="-mt-[3px] border-orange-400 dark:border-orange-700" />
      <TrackedSection className="-mt-[3px] border-yellow-400 dark:border-yellow-700" />
    </>
  }
>
  <div className="absolute left-0 right-0 top-0 h-screen">
    <div className="flex h-screen items-center justify-center">test</div>
  </div>
</StickyContainer>
