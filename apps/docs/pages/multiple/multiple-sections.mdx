    ...
    <StickyContainer
      overlay={
        <>
          <TrackedSection
            sectionID="RED"
            className="border-rose-400 dark:border-rose-700 bg-rose-200 dark:bg-rose-800 rounded-t-lg"
          />
          <TrackedSection
            sectionID="ORANGE"
          ...
          <TrackedSection
            sectionID="PURPLE"
            className="-mt-[3px] border-purple-400 dark:border-purple-700 bg-purple-200 dark:bg-purple-800 rounded-b-lg"
          />
        </>
      }
    >
