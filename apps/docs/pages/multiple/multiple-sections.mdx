...
<TrackedSection className="bg-emerald-100 dark:bg-emerald-700" />
<TrackedSection className="bg-yellow-100 dark:bg-yellow-700" />
<TrackedSection className="bg-sky-100 dark:bg-sky-700" />
